...
<img src="https://raw.githubusercontent.com/TeamUbundi/TeamUbundi/main/.github/assets/banner.svg" alt="Ubundi Work Agent" width="100%" />
...
```mermaid
flowchart LR
    A[Intent Shaped] --> B[Reviewed & Scoped]
    B --> C[🤖 Work Agent Produces]
    C --> D[Artifact Delivered]
    D --> E[Human Review → Publish]
```
...
![GitHub](https://img.shields.io/badge/GitHub-TeamUbundi-181717?logo=github&style=flat-square)
![Status](https://img.shields.io/badge/status-active-success?style=flat-square)
![Role](https://img.shields.io/badge/role-work__agent-0366d6?style=flat-square)
